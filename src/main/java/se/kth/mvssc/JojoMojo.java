...
@Mojo(name = "mvssc", threadSafe = true, defaultPhase = LifecyclePhase.PACKAGE,
        requiresDependencyCollection = ResolutionScope.TEST,
        requiresDependencyResolution = ResolutionScope.TEST)
public class JojoMojo extends AbstractMojo {
    /**
     ...
     */
    @Parameter(property = "createPomDebloated", defaultValue = "true")
    ...
    /**
     * Prepare for generation of specialized jar, and actually generate the
     * specialized jar
     *
     * @param dependencyIdAndVersion
     * @param specializedDirectory
     * @throws Exception
     */
    private String makeSpecializedJarInLocalMavenRepoAndReturnItsName(String dependencyIdAndVersion,
                                                                      File specializedDirectory) throws Exception {
    ...
    /**
     * Create a trimmed directory for a used dependency with unused types removed
     * Use the contents of this new directory to create a specialized jar
     *
     * @param dependencyAndUnusedTypesMap
     * @throws Exception
     */
    ...
    /**
     * Create a map of dependencies and the types within them that are not used by this project
     *
     * @param analysis
     * @return
     */
    ...
    @Override
    public void execute() {
        getLog().info("Hi there, I'm a new plugin!");
        ...
        try {
            ...
            if (libraryToSpecialize != null) {
                ...
                // Replace original dependency in debloated pom with specialized jar
